...
const zh = {
  ...
  "index.summary": "把你写的规划锚在 git 的真实提交上：哪个项目在腐烂、下一步是什么、卡在哪，一屏看清。",
  ...
  "workspace.plan": "规划与任务", "workspace.decisions": "决策记录",
  ...
  "task.kicker": "规划", "task.title": "任务清单", "task.new": "新增任务", "task.unclear": "未成形（?）", "task.add": "添加任务", "task.addDisabled": "先输入任务内容", "task.loading": "正在加载任务…", "task.empty": "还没有任务。先记录一个具体的下一步。", "task.status": "任务状态", "task.due": "预期完成日期", "task.advance": "让 Agent 拆解", "task.advanceReady": "Agent 已生成候选子任务，请选择要采纳的条目。", "task.remove": "删除",
  ...
  "board.viewLabel": "任务视图", "board.viewList": "列表", "board.viewTime": "按时间", "board.moveTo": "移动到",
  "time.overdue": "逾期", "time.today": "今天", "time.thisWeek": "本周", "time.nextWeek": "下周", "time.later": "以后", "time.unscheduled": "未排期", "time.empty": "没有待到期的任务。",
  "focus.title": "今日聚焦", "focus.summary": "{projects} 个项目共 {items} 条任务逾期或今日到期", "board.locked": "状态由当前承诺处置管理", "board.overdue": "逾期 {days} 天", "board.dueSoon": "{days} 天后到期", "board.dueToday": "今天到期",
  ...
  "plan.kicker": "决策记录", "plan.title": "为什么这么做，为什么不做", "plan.newTitle": "这次决定了什么", "plan.body": "为什么（可选）", "plan.add": "记下来", "plan.addDisabled": "先写下决定了什么", "plan.loading": "正在加载决策…", "plan.empty": "还没有记录。决定不做什么，也值得写下来。", "plan.status": "决策状态", "plan.planned": "已计划", "plan.doing": "进行中", "plan.done": "已完成", "plan.abandoned": "已放弃", "plan.commit": "锚定到提交", "plan.commitNone": "未锚定",
...
const en: Record<MessageKey, string> = {
  ...
  "commitment.auditFailed": "State saved; the audit commit failed. Your change is durable — no need to resend.", "commitment.conflict": "This project changed since you started. The latest state is loaded; review it and resubmit — your text is kept.", "commitment.confirmSuccess": "Commitment confirmed.", "commitment.completeSuccess": "Commitment completed.", "commitment.clearSuccess": "Commitment cleared.", "commitment.undoSuccess": "Last change undone.",
  ...
  "board.viewLabel": "Task view", "board.viewList": "List", "board.viewTime": "By time", "board.moveTo": "Move to",
  ...
  "focus.title": "Today's focus", "focus.summary": "{items} task(s) overdue or due today across {projects} project(s)", "board.locked": "Status is managed by commitment actions", "board.overdue": "Overdue {days}d", "board.dueSoon": "Due in {days}d", "board.dueToday": "Due today",
  ...
  "plan.kicker": "Decision record", "plan.title": "Why this, why not that", "plan.newTitle": "What did you decide", "plan.body": "Why (optional)", "plan.add": "Record it", "plan.addDisabled": "Write what you decided first", "plan.loading": "Loading decisions…", "plan.empty": "Nothing recorded yet. Deciding not to do something is worth writing down too.", "plan.status": "Decision status", "plan.planned": "Planned", "plan.doing": "Doing", "plan.done": "Done", "plan.abandoned": "Abandoned", "plan.commit": "Anchor to a commit", "plan.commitNone": "Not anchored",
