...
it("links a decision to a commit with the current document revision", async () => {
  ...
  const input = await screen.findByRole("textbox", { name: /linked commit sha: use external validation/i });
